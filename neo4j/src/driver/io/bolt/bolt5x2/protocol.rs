...
impl_reset!((BoltStructTranslator), Bolt5x2<T>, ResetHandler5x0);
impl_run!((BoltStructTranslator), Bolt5x2<T>, RunHandler5x2);
impl_discard!((BoltStructTranslator), Bolt5x2<T>, DiscardHandler5x0);
impl_pull!((BoltStructTranslator), Bolt5x2<T>, PullHandler5x0);
impl_begin!((BoltStructTranslator), Bolt5x2<T>, BeginHandler5x2);
impl_commit!((BoltStructTranslator), Bolt5x2<T>, CommitHandler5x0);
impl_rollback!((BoltStructTranslator), Bolt5x2<T>, RollbackHandler5x0);
impl_route!((BoltStructTranslator), Bolt5x2<T>, RouteHandler5x0);
impl_telemetry!((BoltStructTranslator), Bolt5x2<T>, TelemetryNoOpHandler);
impl_response!(
...
impl_load_value!((BoltStructTranslator), Bolt5x2<T>);
