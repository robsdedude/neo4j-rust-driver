...
impl_reset!((BoltStructTranslator), Bolt5x1<T>, ResetHandler5x0);
impl_run!((BoltStructTranslator), Bolt5x1<T>, RunHandler5x0);
impl_discard!((BoltStructTranslator), Bolt5x1<T>, DiscardHandler5x0);
impl_pull!((BoltStructTranslator), Bolt5x1<T>, PullHandler5x0);
impl_begin!((BoltStructTranslator), Bolt5x1<T>, BeginHandler5x0);
impl_commit!((BoltStructTranslator), Bolt5x1<T>, CommitHandler5x0);
impl_rollback!((BoltStructTranslator), Bolt5x1<T>, RollbackHandler5x0);
impl_route!((BoltStructTranslator), Bolt5x1<T>, RouteHandler5x0);
impl_telemetry!((BoltStructTranslator), Bolt5x1<T>, TelemetryNoOpHandler);
impl_response!(
...
impl_load_value!((BoltStructTranslator), Bolt5x1<T>);
