...
use super::common::{
    notification_filter_entries_count, write_bookmarks_entry, write_db_entry, write_imp_user_entry,
    write_mode_entry, write_notification_filter_entries, write_parameter_dict,
    write_tx_metadata_entry, write_tx_timeout_entry,
};
use super::run_5x0::RunHandler5x0;
use crate::error_::Result;

pub(in super::super) struct RunHandler5x2();
...
impl RunHandler5x2 {
    ...
    >(
        ...
        let extra_size = notification_filter_entries_count(notification_filter)
            + [
        ...
        callbacks = RunHandler5x0::install_qid_hook(data, callbacks);
