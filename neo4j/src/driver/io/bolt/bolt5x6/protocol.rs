...
impl_hello!((BoltStructTranslator), Bolt5x6<T>, HelloHandler5x4);
impl_reauth!((BoltStructTranslator), Bolt5x6<T>, ReauthHandler5x1);
impl_goodbye!((BoltStructTranslator), Bolt5x6<T>, GoodbyeHandler5x0);
impl_reset!((BoltStructTranslator), Bolt5x6<T>, ResetHandler5x0);
impl_run!((BoltStructTranslator), Bolt5x6<T>, RunHandler5x6);
impl_discard!((BoltStructTranslator), Bolt5x6<T>, DiscardHandler5x6);
impl_pull!((BoltStructTranslator), Bolt5x6<T>, PullHandler5x6);
impl_begin!((BoltStructTranslator), Bolt5x6<T>, BeginHandler5x2);
impl_commit!((BoltStructTranslator), Bolt5x6<T>, CommitHandler5x0);
impl_rollback!((BoltStructTranslator), Bolt5x6<T>, RollbackHandler5x0);
impl_route!((BoltStructTranslator), Bolt5x6<T>, RouteHandler5x0);
impl_telemetry!((BoltStructTranslator), Bolt5x6<T>, TelemetryHandler5x4);
impl_response!(
...
impl_load_value!((BoltStructTranslator), Bolt5x6<T>);
